      ...
      <ol className="relative border-l border-gray-200 dark:border-gray-700 mt-5">
        {companyList.map((company,index) => (
          <li className="mb-10 ml-6" key={index}>
            ...
            <time className="block mb-2 text-sm  font-semibold leading-none text-gray-700 dark:text-gray-500">
              {company.post}
            </time>
            <p className="mb-2 text-xs font-semibold text-gray-400 dark:text-gray-400">
              {company.location}
            </p>
